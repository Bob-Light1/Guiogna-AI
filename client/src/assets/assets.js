...
export const SchoolData = [
    {
      ...
      description: 'Manage student records, enrollment, and profiles with ease.',
      Icon: GraduationCap,
      bg: { from: '#3588F2', to: '#0BB0D7' },
      path: '/'
    },
    {
      ...
      description: 'Oversee teacher profiles, schedules, and performance efficiently.',
      Icon: UserCog,
      bg: { from: '#B153EA', to: '#E549A3' },
      path: '/'
    },
    {
      ...
      description: 'Track school fees, payments, and financial reporting accurately.',
      Icon: Wallet,
      bg: { from: '#20C363', to: '#16A56F' }, // léger ajustement pour plus de contraste
      path: '/'
    },
    {
      title: 'Courses Management',
      description: 'Create, assign, and organize academic courses and materials.',
      Icon: BookOpenCheck,
      bg: { from: '#F76C1C', to: '#F04A3C' },
      path: '/'
    },
    {
      ...
      description: 'Schedule and administer exams securely and effectively.',
      Icon: FileCheck,
      bg: { from: '#5C6AF1', to: '#3D6DF5' },
      path: '/'
    },
    {
      title: 'Results Management',
      description: 'Publish and analyze student results with insightful reports.',
      Icon: BarChart3,
      bg: { from: '#12B7AC', to: '#08B6CE' },
      path: '/'
    }
